...
<body>
    <header>
        <div class="header-container">
            <div class="logo">Porsche 911 GT3 RS</div>
            <nav>
    ...
    <div class="container" id="main-content">
        ...
        <section id="mecanica" class="section">
            <div class="container">
                <h2>Mecánica</h2>
                <ul>
                    <li><strong>Motorización:</strong> Motor bóxer atmosférico de 4.0 litros y seis cilindros que produce 525 CV a 8.500 rpm y 465 Nm de par a 6.300 rpm.</li>
                    <li><strong>Transmisión:</strong> Automática PDK de 7 velocidades.</li>
                    <li><strong>Tracción:</strong> Trasera (RWD).</li>
                    <img src="media/Porsche 911 gt3 rs Motor.jpg" alt="Motor Porsche 911 GT3 RS" width="800" height="500" />
                </ul>
            </div>
        </section>
        <section id="interior" class="section">
            <div class="container">
                <h2>Interior</h2>
                <ul>
                    <li><strong>Diseño y materiales:</strong> Enfocado en el rendimiento, con asientos tipo baquet de fibra de carbono, acabados en Alcántara y detalles en contraste.</li>
                    <li><strong>Tecnología:</strong> Cuadro de instrumentos digital con información centrada en pista, sistema PCM con funciones específicas para circuitos y telemetría.</li>
                    <li><strong>Comodidades:</strong> Equipamiento reducido para aligerar peso; opciones de confort disponibles bajo pedido.</li>
                    <img src="media/Porsche 911 gt3 rs Interior.jpg" alt="Interior Porsche 911 GT3 RS" width="800" height="500" />
                </ul>
            </div>
        </section>
        <section id="exterior" class="section">
            <div class="container">
                <h2>Exterior</h2>
                <ul>
                    <li><strong>Diseño:</strong> Aerodinámica extrema con alerones prominentes, tomas de aire adicionales y elementos en fibra de carbono.</li>
                    <li><strong>Iluminación:</strong> Faros LED oscuros.</li>
                    <img src="media/Porsche 911 GT3 RS.jpg" alt="Exterior Porsche 911 GT3 RS" width="800" height="500" />
                </ul>
            </div>
        </section>
        <section id="adquirir" class="section">
            <div class="container">
                <h2>Adquirir Porsche 911 GT3 RS</h2>
                ...
                <form id="compraForm" class="animate-show" method="POST" action="#adquirir" style="display:none;">
                    ...
                    <input type="text" id="precio" name="precio" value="$4,778,000" readonly />

                    <label for="color">Color del vehículo:</label>
                    <select id="color" name="color" required>
                        <?php
                        $colors = ['Negro', 'Blanco', 'Rojo', 'Plata'];
    ...
    <script>
        ...
        showFormBtn.addEventListener('click', () => {
            ...
            setTimeout(() => {
                compraForm.classList.add('visible');
            }, 10);
        ...
        window.onload = function() {
            <?php if ($_SERVER['REQUEST_METHOD'] === 'POST'): ?>
                compraForm.style.display = 'block';
                compraForm.classList.add('visible');
                document.getElementById('resumenPedido').style.display = 'table';
                adquirirSection.scrollIntoView({behavior: 'smooth'});
                showFormBtn.style.display = 'none';
            <?php else: ?>
