...
<body>
    ...
    <header>
        <div class="header-container">
            <div class="logo">Porsche Taycan</div>
            <nav>
    ...
    <div class="container" id="main-content">
        ...
        <section id="mecanica" class="section">
            <div class="container">
                <h2>Mecánica</h2>
                <ul>
                    <li><strong>Motorización:</strong> Totalmente eléctrico, disponible en versiones desde el Taycan 4S con 530 CV hasta el Taycan Turbo S con 761 CV en overboost.</li>
                    <li><strong>Batería:</strong> Equipado con baterías de iones de litio de 79,2 kWh o 93,4 kWh, según la versión.</li>
                    <li><strong>Autonomía:</strong> Dependiendo de la versión y el ciclo de conducción, la autonomía varía entre 350 y 450 km.</li>
                </ul>
                <img src="media/Porsche Taycan Motor.jpg" alt="Motor Porsche Taycan" />
            </div>
        </section>
        ...
        <section id="interior" class="section">
            <div class="container">
                <h2>Interior</h2>
                <ul>
                    <li><strong>Diseño y materiales:</strong> Interior minimalista y futurista con materiales sostenibles y opciones de cuero tradicional.</li>
                    <li><strong>Tecnología:</strong> Varias pantallas táctiles, incluyendo una para el pasajero, sistema PCM avanzado, integración con smartphones y opciones de realidad aumentada en el sistema de navegación.</li>
                    <li><strong>Comodidades:</strong> Asientos calefactados y ventilados, climatizador de cuatro zonas y sistemas de asistencia al conductor de última generación.</li>
                </ul>
                <img src="media/Porsche Taycan Interior.jpg" alt="Interior Porsche Taycan" />
            </div>
        </section>
        ...
        <section id="exterior" class="section">
            <div class="container">
                <h2>Exterior</h2>
                <ul>
                    <li><strong>Diseño:</strong> Combina elementos clásicos de Porsche con una estética futurista; líneas limpias y aerodinámicas.</li>
                    <li><strong>Iluminación:</strong> Faros LED Matrix y una franja luminosa trasera continua.</li>
                    <li><strong>Opciones:</strong> Techo panorámico de vidrio, diversos diseños de llantas y paquetes deportivos.</li>
                </ul>
                <img src="media/Porsche Taycan.jpg" alt="Porsche Taycan" />
            </div>
        </section>

        <section id="adquirir" class="section">
            <div class="container">
                <h2>Adquirir Porsche Taycan</h2>
                ...
                <form id="compraForm" class="animate-show" method="POST" action="#adquirir" style="display:none;">
                    ...
                    <input type="text" id="precio" name="precio" value="$3,200,000" readonly />
