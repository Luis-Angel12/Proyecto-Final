...
<body>
    <header>
        <div class="header-container">
            <div class="logo">Porsche 911</div>
            <nav>
    ...
    <div class="container" id="main-content">
        ...
        <section id="mecanica" class="section">
            <div class="container">
                <h2>Mecánica</h2>
                <ul>
                    <li><strong>Motorización:</strong> La gama 911 ofrece diversas opciones de motorización, desde el Carrera con un motor bóxer de seis cilindros y 3.0 litros turboalimentado que produce 385 CV, hasta el Turbo S con un motor de 3.8 litros que alcanza 650 CV.</li>
                    <li><strong>Transmisión:</strong> Se dispone de una transmisión automática PDK de 8 velocidades y, en algunas versiones, una manual de 7 velocidades.</li>
                    <li><strong>Tracción:</strong> Dependiendo de la versión, puede ser trasera (RWD) o total (AWD).</li>
                </ul>
                <img src="media/Porsche 911 motor.jpg" alt="Motor Porsche 911" />
            </div>
        </section>
        <section id="interior" class="section">
            <div class="container">
                <h2>Interior</h2>
                <ul>
                    <li><strong>Diseño y materiales:</strong> El habitáculo combina lujo y deportividad, con materiales de alta calidad como cuero, aluminio y fibra de carbono.</li>
                    <li><strong>Tecnología:</strong> Cuenta con una pantalla táctil central de alta resolución, sistema de infoentretenimiento Porsche Communication Management (PCM), compatibilidad con Apple CarPlay y Android Auto, y un cuadro de instrumentos digital combinado con tacómetro analógico central.</li>
                    <li><strong>Comodidades:</strong> Asientos deportivos ajustables, climatizador bizona y opciones de personalización que incluyen sistemas de sonido premium y paquetes de iluminación ambiental.</li>
                </ul>
                <img src="media/Porsche 911 Interior.jpg" alt="Interior Porsche 911" />
            </div>
        </section>
        <section id="exterior" class="section">
            <div class="container">
                <h2>Exterior</h2>
                <ul>
                    <li><strong>Diseño:</strong> Mantiene la silueta clásica del 911 con líneas modernas y aerodinámicas.</li>
                    <li><strong>Iluminación:</strong> Faros LED Matrix con luces diurnas de cuatro puntos y pilotos traseros unidos por una franja luminosa.</li>
                    <li><strong>Opciones:</strong> Variedad de diseños de llantas, colores de carrocería y paquetes estéticos como el SportDesign.</li>
                </ul>
                <img src="media/Porsche 911.jpg" alt="Exterior Porsche 911" />
            </div>
        </section>
        <section id="adquirir" class="section">
            <div class="container">
                <h2>Adquirir Porsche 911</h2>
                ...
                <form id="compraForm" class="animate-show" method="POST" action="#adquirir" style="display:none;">
                    ...
                    <input type="text" id="precio" name="precio" value="$2,418,000" readonly />
